...
public class PlayerHUD {
	...
	public void render(Graphics g, Sprite player) {
		if (debugMode) {
			...
			g.drawString("Velocity: (" + player.xVel + ", " + player.yVel + ")", 7, 60);
			g.drawString("FPS: " + Game.FPS + "/" + Game.FPSmax, 7, 80);
			g.drawString("TPS: " + Game.TPS + "/" + Game.TPSmax, 7, 100);
			g.drawString("Standing on: " + player.standingOn, 7, 120);
			g.drawString("Side collision: " + player.sideCollision, 7, 140);
